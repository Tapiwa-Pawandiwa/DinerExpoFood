...
const HostMealCard = ({mealObj}) => {
  ...
  const {mealContext, setMealContext, setHostContext,hostContext} = useBasketContext();
      ...
      host && meal && (
        <TouchableOpacity style={styles.cardContainer} onPress={handlePress}>
          <View style={styles.imageContainer}>
            <Image source={{uri: meal.imageURI}} style={styles.mealStyle} />
            <Image source={{uri: host.imageURI}} style={styles.hostStyle} />
          </View>
          <View style={styles.headingContainer}>
            <View style={styles.subHeadContainer}>
              <Text style={styles.headingStyle}>{meal.name}</Text> 
            </View>
